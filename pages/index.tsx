...
import goonsLogo from "../assets/images/goonsLogo.png";
  ...
  return (
    <div className="">
      <main className={styles.main}>
        ...
        <div className={"flex flex-col lg:flex-row mx-auto justify-center px-6 md:px-16 lg:px-24"}>
          <div className={"flex flex-col mx-20 hover:animate-scaleintopleft js-show-on-scroll-scaleintopleft transition-all duration-600"}>
            <Image
              className="w-80 h-80 md:w-auto md:h-auto lg:w-screen justify-center align-center z-0 absolute"
              src={goonsPic}
              height={750}
              width={750}
            ></Image>
