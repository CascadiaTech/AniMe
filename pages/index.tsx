    ...
    <div className={"bg-black"}>
      <main className={styles.main}>
        ...
        <div className={"mx-auto self-center "}>
          <p className={"py-5"}></p>
          <p
            style={{ fontFamily: "BeatWord", textShadow: '0px 0px 18px rgba(227,0,0,0.75)' }}
            className={
              "text-3xl lg:text-5xl text-red-100 text-center self-center mx-auto border-b-4 border-red-700"
            }
          >
            AniMe
          </p>
          ...
          <div
            style={{
              boxShadow: 'inset 0px 0px 15px 5px rgba(255,69,69,0.65), 0px 0px 12px 3px rgba(255,41,41,0.65)',
            }}
            className={
              "flex flex-row border-2 border-gray-300 rounded-xl my-6 justify-center"
            }
          >
            <button
              style={{ fontFamily: "MondayFeelings" }}
              className="px-4 m-5 py-2 text-xl cursor-pointer border-2 border-gray-400 rounded-xl duration-300
         ...
         hover:bg-gray-400 hover:border-gray-100 hover:text-gray-900"
          ...
          <div className={"flex flex-row overflow-hidden"}>
            ...
            <div className={"flex flex-col"}>
              ...
              <p className={"mx-32"}></p>
              <div
                style={{ zIndex: image == "HANDITEM" ? 20 : 0, height: 500 }}
                className={
                  "w-1/4 h-1/4 cursor-pointer absolute grid grid-cols-3 gap-1 overflow-scroll px-2 py-2 mx-auto justify-center border-2 border-gray-300 bg-gray-800 rounded-xl"
                }
              >
              ...
              <p className={"mx-32"}></p>
              <div
                style={{ zIndex: image == "MOUTH" ? 20 : 0, height: 500 }}
                className={
                  "w-1/4 h-1/4 cursor-pointer absolute grid grid-cols-3 gap-1 overflow-scroll px-2 py-2 mx-auto justify-center border-2 border-gray-300 bg-gray-800 rounded-xl"
                }
              >
